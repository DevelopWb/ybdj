...
@AutoRefView(id = R.layout.act_record, layout = 0x03)
public class actRecord extends ActGenDataViewActivity1<AudioFileModel> implements RecordAudioPlay.IAudioPlayEventHandle {
	...
	public void LoadAllID() {
		if (_connection != null && _connection.getIsLogined()) {
			_SysIDList = _connection.GetAllID();// 获取所有号码
			LoadFileList();
			InitGridViewActivity(gvGrid, 1, R.layout.item_record, -1,dip2px(this, 70));
